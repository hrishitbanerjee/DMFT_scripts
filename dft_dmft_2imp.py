...
dft_filename = 'filename.h5'          # filename
U = [4.5, 2.5 ]                         # interaction parameters
J = [0.5, 0.5]
...
p[0]["length_cycle"] = 300
p[0]["n_warmup_cycles"] = 20000
p[0]["n_cycles"] = 200000
# tail fit
#p[0]["perform_tail_fit"] = False
p[0]["perform_tail_fit"] = True
p[0]["fit_max_moment"] = 2
p[0]["fit_min_n"] = 30
p[0]["fit_max_n"] = 90
...
for iteration_number in range(1,loops+1):
    ...
    #    for ii in xrange(4): SK.symm_deg_gf(S[ii].Sigma_iw)                        # symmetrizing Sigma for iteration=1
    ...
    if mpi.is_master_node():
        with HDFArchive(dft_filename+'.h5','a') as ar:
            ar['dmft_output']['G_0_Fe1']      = S[0].G0_iw
            ar['dmft_output']['G_0_Fe2']      = S[1].G0_iw
          #  ar['dmft_output']['G_0_Co']      = S[2].G0_iw
    ...
    if (iteration_number>1 or previous_present):
        if mpi.is_master_node():
            ...
            S[0].Sigma_iw << mix * S[0].Sigma_iw + (1.0-mix) * ar['dmft_output']['Sigma_iw_Fe21']
            S[1].Sigma_iw << mix * S[1].Sigma_iw + (1.0-mix) * ar['dmft_output']['Sigma_iw_Fe22']
            S[0].G_iw << mix * S[0].G_iw + (1.0-mix) * ar['dmft_output']['G_iw_Fe21']
            S[1].G_iw << mix * S[1].G_iw + (1.0-mix) * ar['dmft_output']['G_iw_Fe22']
            for ii in range(2):
    ...
    if mpi.is_master_node():
        with HDFArchive(dft_filename+'.h5','a') as ar:
            ...
            ar['dmft_output']['G_0_Fe1']      = S[0].G0_iw
            ar['dmft_output']['G_tau_Fe1']    = S[0].G_tau
            ar['dmft_output']['G_iw_Fe1']     = S[0].G_iw
            ar['dmft_output']['Sigma_iw_Fe1'] = S[0].Sigma_iw
            ar['dmft_output']['G_0_Fe2']      = S[1].G0_iw
            ar['dmft_output']['G_tau_Fe2']    = S[1].G_tau
            ar['dmft_output']['G_iw_Fe2']     = S[1].G_iw
            ar['dmft_output']['Sigma_iw_Fe2'] = S[1].Sigma_iw
    ...
    if mpi.is_master_node():
        with HDFArchive(dft_filename+'.h5','a') as ar:
            G_iw_Fe1=ar['dmft_output']['G_iw_Fe1']
            dm_Fe1=G_iw_Fe1.density()
            occ_up_Fe1=dm_Fe1['up_0'][0][0]+dm_Fe1['up_1'][0][0]+dm_Fe1['up_2'][0][0]+dm_Fe1['up_3'][0][0]+dm_Fe1['up_4'][0][0]
            occ_dn_Fe1=dm_Fe1['down_0'][0][0]+dm_Fe1['down_1'][0][0]+dm_Fe1['down_2'][0][0]+dm_Fe1['down_3'][0][0]+dm_Fe1['down_4'][0][0]
            
            G_iw_Fe2=ar['dmft_output']['G_iw_Fe2']
            dm_Fe2=G_iw_Fe2.density()
            occ_up_Fe2=dm_Fe2['up_0'][0][0]+dm_Fe2['up_1'][0][0]+dm_Fe2['up_2'][0][0]+dm_Fe2['up_3'][0][0]+dm_Fe2['up_4'][0][0]
            occ_dn_Fe2=dm_Fe2['down_0'][0][0]+dm_Fe2['down_1'][0][0]+dm_Fe2['down_2'][0][0]+dm_Fe2['down_3'][0][0]+dm_Fe2['down_4'][0][0]

        wannier_moment_Fe1=occ_up_Fe1-occ_dn_Fe1
        wannier_moment_Fe2=occ_up_Fe2-occ_dn_Fe2
        mpi.report("Wannier Moment Fe1: %.6f"%wannier_moment_Fe1.real)
        mpi.report("Wannier Moment Fe2: %.6f"%wannier_moment_Fe2.real)
